...
class Conjunto
{
    ...
    private:
        ...
        void destruir(Nodo*);
        bool perteneceRecursivo(Nodo*, const T&) const;
        void removerRecursivo(Nodo*,const T&);
        const T& minimoRecursivo(Nodo*) const;
        const T& maximoRecursivo(Nodo*) const;
        bool esHoja(Nodo*);
        const T& siguienteRecursivo(Nodo*);
        unsigned int cardinalRecursivo(Nodo*) const;
